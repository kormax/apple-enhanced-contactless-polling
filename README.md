...
- CarKey Setup:  
  ...
  <img src="./assets/CARKEY.SETUP.DEMO.webp" alt="![Image showing CarKey pairing prompt]" width=250px>
- Field ignore:  
...
- AirDrop:
  Replaces field ignore in IOS17 for background reading, used to negotiate an AirDrop session. NameDrop is a special case of AirDrop.
