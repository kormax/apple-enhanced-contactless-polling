...
When the device makes a routing decision, it usually shows a card image with a spinner.

<img src="./assets/EM.DECISION.webp" alt="Image showing express mode animation after decision" width=250px>

The moment when this happens depends on the underlying protocol:
- FeliCa: immediately after the routing decision is made;
- EMV: after the ISO7816 AID of the payment network is selected;
- T-Union/T-Money: immediately after the routing decision is made;
- VAS: after attempted `GET_DATA` for a known `passIssuerIdentifier`;
- Calypso: after a matching ISO7816 AID is selected;
- Mifare: after a valid ISO7816 AID or native Mifare AID selection;
- Seos: after a valid ADF is selected;
- Unified Access (Aliro/CarKey/HomeKey/AccessKey): after a `readerGroupIdentifier` matching a known credential is sent in `AUTH0`.
...
<sub>Tests were conducted using very big intervals between polling frames. IRL, if polling is faster, the device might respond after more frames than shown, presumably because of internal processing delay.</sub>
...
Terminal Capabilities Identifier (TCI) is an arbitrary three-byte-long value that establishes a reader's relation to a particular pass type (Home key, Automotive key), system feature (Ignore, GymKit, Identity, AirDrop, NameDrop), or reader installation (Access, Transit).
...
- Access (Automotive/Home/University/Office/Venue): The first byte is either 0x02/0x04/0x05/0x82 outright or has its high nibble set to 0x2, and the remaining bytes link to a particular property or system;
...
| GymKit                                      | 01      | NA   | NA             | c3 00 00     | NA                         | Bruteforce                                   | The only way to trigger GymKit on an Apple Watch. There are other frames that trigger GymKit too, but they also trigger express transit for iPhones                 |
...
| Access: Automotive: (No Reader ID)          | 02      | 02   | 0[1/8]         | XX XX XX     | NA                         | Sniffing                                     |                                                                                                                                                                   |
| Access: Automotive: Charger (Ignore)        | 02      | 02   | 01             | 01 0f ff     | NA                         | iOS firmware analysis                        | Acts as an alternative to `Ignore`                                                                                                                                |
| Access: Automotive: (Reader ID)             | 02      | 02   | 0[5/a]         | XX XX XX     | XX XX XX XX XX XX XX XX    | Sniffing/Bruteforce                          |                                                                                                                                                                   |
| Access: Automotive: Pairing: (No Reader ID) | 02      | 02   | 09             | XX XX XX     | NA                         | Bruteforce                                   |                                                                                                                                                                   |
| Access: Automotive: Pairing: (Reader ID)    | 02      | 02   | 0b             | XX XX XX     | NA                         | Bruteforce                                   |                                                                                                                                                                   |
| Access: Automotive: BMW/MINI                | 02      | 02   | 0[1/5/8/9/a/b] | 01 00 0[1-3] | NA/XX XX XX XX XX XX XX XX | Sniffing/Configuration                       |                                                                                                                                                                   |
| Access: Automotive: KIA                     | 02      | 02   | 0[1/5/8/9/a/b] | 01 00 4[1-6] | NA/XX XX XX XX XX XX XX XX | Configuration                                |                                                                                                                                                                   |
| Access: Automotive: Genesis                 | 02      | 02   | 0[1/5/8/9/a/b] | 01 00 5[1-7] | NA/XX XX XX XX XX XX XX XX | Configuration                                |                                                                                                                                                                   |
| Access: Automotive: Lotus                   | 02      | 02   | 0[1/5/8/9/a/b] | 01 00 9[1-6] | NA/XX XX XX XX XX XX XX XX | Configuration                                |                                                                                                                                                                   |
| Access: Automotive: NIO (1)                 | 02      | 02   | 0[1/5/8/9/a/b] | 01 00 a[1-6] | NA/XX XX XX XX XX XX XX XX | Configuration                                |                                                                                                                                                                   |
| Access: Automotive: NIO (2)                 | 02      | 02   | 0[1/5/8/9/a/b] | 01 00 b[1-6] | NA/XX XX XX XX XX XX XX XX | Configuration                                |                                                                                                                                                                   |
| Access: Automotive: Skoda                   | 02      | 02   | 0[1/5/8/9/a/b] | 01 00 e[1-6] | NA/XX XX XX XX XX XX XX XX | Sniffing                                     |                                                                                                                                                                   |
| Access: Automotive: Audi                    | 02      | 02   | 0[1/5/8/9/a/b] | 01 01 1[1-6] | NA/XX XX XX XX XX XX XX XX | Configuration                                |                                                                                                                                                                   |
| Access: Automotive: Porsche                 | 02      | 02   | 0[1/5/8/9/a/b] | 01 01 2[1-6] | NA/XX XX XX XX XX XX XX XX | Configuration                                |                                                                                                                                                                   |
| Access: Automotive: Polestar (1)            | 02      | 02   | 0[1/5/8/9/a/b] | 01 01 3[1-6] | NA/XX XX XX XX XX XX XX XX | Configuration                                |                                                                                                                                                                   |
| Access: Automotive: Cadillac                | 02      | 02   | 0[1/5/8/9/a/b] | 01 01 6[1-6] | NA/XX XX XX XX XX XX XX XX | Configuration                                |                                                                                                                                                                   |
| Access: Automotive: Lynk & Co               | 02      | 02   | 0[1/5/8/9/a/b] | 01 01 a[1-6] | NA/XX XX XX XX XX XX XX XX | Sniffing/Configuration                       |                                                                                                                                                                   |
| Access: Automotive: Zeekr                   | 02      | 02   | 0[1/5/8/9/a/b] | 01 01 b[1-6] | NA/XX XX XX XX XX XX XX XX | Sniffing/Configuration                       |                                                                                                                                                                   |
| Access: Automotive: Smart                   | 02      | 02   | 0[1/5/8/9/a/b] | 01 01 e[1-6] | NA/XX XX XX XX XX XX XX XX | Configuration                                |                                                                                                                                                                   |
| Access: Automotive: Mercedes                | 02      | 02   | 0[1/5/8/9/a/b] | 01 02 0[1-6] | NA/XX XX XX XX XX XX XX XX | Configuration                                |                                                                                                                                                                   |
| Access: Automotive: RAM                     | 02      | 02   | 0[1/5/8/9/a/b] | 01 02 2[1-6] | NA/XX XX XX XX XX XX XX XX | Configuration                                |                                                                                                                                                                   |
| Access: Automotive: Denza                   | 02      | 02   | 0[1/5/8/9/a/b] | 01 02 4[1-6] | NA/XX XX XX XX XX XX XX XX | Configuration                                |                                                                                                                                                                   |
| Access: Automotive: Volvo (1)               | 02      | 02   | 0[1/5/8/9/a/b] | 01 02 9[1-6] | NA/XX XX XX XX XX XX XX XX | Configuration                                |                                                                                                                                                                   |
| Access: Automotive: Polestar (2)            | 02      | 02   | 0[1/5/8/9/a/b] | 01 02 a[1-6] | NA/XX XX XX XX XX XX XX XX | Configuration                                |                                                                                                                                                                   |
| Access: Automotive: YW                      | 02      | 02   | 0[1/5/8/9/a/b] | 01 02 b[1-6] | NA/XX XX XX XX XX XX XX XX | Configuration                                |                                                                                                                                                                   |
| Access: Automotive: FCB                     | 02      | 02   | 0[1/5/8/9/a/b] | 01 02 d[1-6] | NA/XX XX XX XX XX XX XX XX | Configuration                                |                                                                                                                                                                   |
| Access: Automotive: Rivian                  | 02      | 02   | 0[1/5/8/9/a/b] | 01 02 e[1-6] | NA/XX XX XX XX XX XX XX XX | Configuration                                |                                                                                                                                                                   |
| Access: Automotive: Hyundai                 | 02      | 02   | 0[1/5/8/9/a/b] | 01 03 0[1-6] | NA/XX XX XX XX XX XX XX XX | Configuration                                |                                                                                                                                                                   |
| Access: Automotive: Chery                   | 02      | 02   | 0[1/5/8/9/a/b] | 01 03 1[1-6] | NA/XX XX XX XX XX XX XX XX | Configuration                                |                                                                                                                                                                   |
| Access: Automotive: Jetour                  | 02      | 02   | 0[1/5/8/9/a/b] | 01 03 3[1-6] | NA/XX XX XX XX XX XX XX XX | Configuration                                |                                                                                                                                                                   |
| Access: Automotive: Xpeng                   | 02      | 02   | 0[1/5/8/9/a/b] | 01 03 8[1-6] | NA/XX XX XX XX XX XX XX XX | Configuration                                |                                                                                                                                                                   |
| Access: Automotive: Hongqi                  | 02      | 02   | 0[1/5/8/9/a/b] | 01 03 b[1-6] | NA/XX XX XX XX XX XX XX XX | Configuration                                |                                                                                                                                                                   |
| Access: Automotive: Volvo (2)               | 02      | 02   | 0[1/5/8/9/a/b] | 01 04 0[1-6] | NA/XX XX XX XX XX XX XX XX | Configuration                                |                                                                                                                                                                   |
| Access: Automotive: SAIC Audi               | 02      | 02   | 0[1/5/8/9/a/b] | 01 04 6[1-6] | NA/XX XX XX XX XX XX XX XX | Configuration                                |                                                                                                                                                                   |
| Access: Automotive: FAW Audi                | 02      | 02   | 0[1/5/8/9/a/b] | 01 04 8[1-6] | NA/XX XX XX XX XX XX XX XX | Configuration                                |                                                                                                                                                                   |
| Access: Automotive: Lexus (1)               | 02      | 02   | 0[1/5/8/9/a/b] | 01 05 1[1-6] | NA/XX XX XX XX XX XX XX XX | Configuration                                |                                                                                                                                                                   |
| Access: Automotive: Toyota (GR)             | 02      | 02   | 0[1/5/8/9/a/b] | 01 05 2[1-6] | NA/XX XX XX XX XX XX XX XX | Configuration                                |                                                                                                                                                                   |
| Access: Automotive: Voyah (1)               | 02      | 02   | 0[1/5/8/9/a/b] | 01 05 5[1-6] | NA/XX XX XX XX XX XX XX XX | Configuration                                |                                                                                                                                                                   |
| Access: Automotive: Voyah (2)               | 02      | 02   | 0[1/5/8/9/a/b] | 01 05 6[1-6] | NA/XX XX XX XX XX XX XX XX | Configuration                                |                                                                                                                                                                   |
| Access: Automotive: FAW Toyota              | 02      | 02   | 0[1/5/8/9/a/b] | 01 05 c[1-6] | NA/XX XX XX XX XX XX XX XX | Configuration                                |                                                                                                                                                                   |
| Access: Automotive: GAC Toyota              | 02      | 02   | 0[1/5/8/9/a/b] | 01 05 d[1-6] | NA/XX XX XX XX XX XX XX XX | Configuration                                |                                                                                                                                                                   |
| Access: Automotive: Lexus (2)               | 02      | 02   | 0[1/5/8/9/a/b] | 01 05 e[1-6] | NA/XX XX XX XX XX XX XX XX | Configuration                                |                                                                                                                                                                   |
| Access: Automotive: Toyota (1)              | 02      | 02   | 0[1/5/8/9/a/b] | 01 06 0[1-6] | NA/XX XX XX XX XX XX XX XX | Configuration                                |                                                                                                                                                                   |
| Access: Automotive: Volkswagen China        | 02      | 02   | 0[1/5/8/9/a/b] | 01 06 7[1-6] | NA/XX XX XX XX XX XX XX XX | Configuration                                |                                                                                                                                                                   |
| Access: Automotive: BYD                     | 02      | 02   | 0[1/5/8/9/a/b] | 01 07 0[1-6] | NA/XX XX XX XX XX XX XX XX | Sniffing/Configuration                       |                                                                                                                                                                   |
| Access: Automotive: GAC-Toyota              | 02      | 02   | 0[1/5/8/9/a/b] | 01 07 5[1-6] | NA/XX XX XX XX XX XX XX XX | Configuration                                |                                                                                                                                                                   |
...
<sub> Source: Bruteforce - found by going over all config combinations; Sniffing - sniffed from a real reader; File - retrieved from pass file; Configuration - retrieved from smp-device-content configuration json; iOS firmware analysis - extracted via static analysis of iOS components</sub>  
...
- Access: Automotive: Pairing: Mercedes:  
  `6a02c30209010201`
  ```
...
- Unified Access (Aliro/Home/Automotive/Access): readers send a transaction-type flag that also feeds the cryptographic input. The device’s policy determines whether that flag requires manual authentication;
...
| Unified Access (Apple CarKey/HomeKey/AccessKey variants) | OP_CONTROL_FLOW(`0x3C`) with success flags or DESELECT after attestation exchange                         | OP_CONTROL_FLOW(`0x3C`) with failure flags or DESELECT/TRESET before it                                                                                               |                                               |
| Aliro                                                    | EXCHANGE(`0xC9`) in secure channel with reader status (`0x97`); success response `0x0002\|\|0x00\|\|0x00` | OP_CONTROL_FLOW(`0x3C`) on failure when secure channel is unavailable; otherwise failure can be conveyed via EXCHANGE status/error; DESELECT/TRESET before completion | Per Aliro v1.0 sections 8.3.3.5, 10.2, 10.2.2 |

<sub>DESFire command name was made up by me because it was newly discovered, and there is no info about it online.</sub>
...
| Calypso       | DESELECT/TRESET after AID selection                                                                           | DESELECT/TRESET before success condition |                                                                                                                                                                                                                                                                                |
...
The command needed to collect traces is `hf 14a sniff`. After activating the command, hold the Proxmark near a reader for a couple of seconds. In some cases, you need to tap/touch the reader to wake it up, as it might not poll to save energy.
...
Some other devices might also be able to sniff the frames, but none can be recommended without firsthand validation.
...
* Resources that helped with research:
  ...
  - Android resources:
    - [Android Observe Mode](https://developer.android.com/reference/android/nfc/NfcAdapter#isObserveModeSupported());
    - [Android Polling Loop Annotations](https://developer.android.com/reference/android/nfc/cardemulation/CardEmulation#registerPollingLoopFilterForService(android.content.ComponentName,%20java.lang.String,%20boolean));
    - [Express Mode for an Enhanced User Experience (Archive)](https://web.archive.org/web/20250405102423/https://developers.google.com/wallet/access/multi-family-key/guides/express-mode).
  ...
  - Other:
    - [AccessGrid - Mobile Wallet DESFire Application Structure](https://accessgrid.com/guides/knowledgebase/accessgrid-desfire-application-structures);
    ...
    - [Apple Wiki - Wallet Payment Networks](https://theapplewiki.com/wiki/Wallet_Payment_Networks).
* Devices and software used for analysis:
  - Proxmark3 Easy - used to sniff ECP frames out. Proxmark3 RDV2/4 can also be used;
  - [IPSW](https://github.com/blacktop/ipsw) - universal toolkit for ios/macOS analysis.
